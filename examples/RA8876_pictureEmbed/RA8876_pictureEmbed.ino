...
void loop(void) {
  ...
  drawImage(240, 320, (uint16_t*)teensy40_pinout1, COLOR16M_RED, false);
  if (DelayOrStep()) return;
  Serial.print("Display Back of card ");
  drawImage(240, 320, (uint16_t*)teensy40_pinout2, COLOR16M_GREEN, false);
  if (DelayOrStep()) return;
#if defined(__IMXRT1062__)
  Serial.print("Display T4.1 Extended card ");
  drawImage(575, 424, (uint16_t*)teensy41_Cardlike, COLOR16M_BLUE, false);
  if (DelayOrStep()) return;
#elif defined(ARDUINO_TEENSY36)
  Serial.print("Display Talldog T4 card ");
  drawImage(400, 272, (uint16_t*)td_t4_top, COLOR16M_BLUE, false);
  if (DelayOrStep()) return;
#endif
#if  defined(__IMXRT1062__) || defined (ARDUINO_TEENSY36)
  Serial.print("Display front of chip ");
  drawImage(240, 320, (uint16_t*)teensy40_front, COLOR16M_BLUE, false);
  if (DelayOrStep()) return;
#endif
  ...
  drawImage(575, 424, (uint16_t*)rotated_image, COLOR16M_DARKGREEN, true);
#elif defined(ARDUINO_TEENSY36)
  Serial.print("Display TallDog T4  pre rotated Card ");
  rotated_image = tft.rotateImageRect(400, 272, (uint16_t*)td_t4_top);
  drawImage(400, 272, (uint16_t*)rotated_image, COLOR16M_DARKGREEN, true);
#elif defined(ARDUINO_TEENSY35)
  Serial.print("Display TallDog T4  pre rotated Card ");
  rotated_image = tft.rotateImageRect(240, 320, (uint16_t*)teensy40_pinout1);
  drawImage(240, 320, (uint16_t*)rotated_image, COLOR16M_DARKGREEN, true);
