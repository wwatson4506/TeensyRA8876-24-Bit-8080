...
const ili_fonts_test_t font_test_list[] = {
  ...
  {&Arial_14, nullptr,  "Arial_14", COLOR16M_WHITE, COLOR16M_WHITE},
  {&Arial_14_Bold, nullptr,  "ArialBold 14", COLOR16M_YELLOW, COLOR16M_YELLOW},
  {&ComicSansMS_14, nullptr,  "ComicSansMS 14", COLOR16M_GREEN, COLOR16M_GREEN},
  {&DroidSans_14, nullptr,  "DroidSans_14", COLOR16M_WHITE, COLOR16M_WHITE},
  {&Michroma_14, nullptr,  "Michroma_14", COLOR16M_YELLOW, COLOR16M_YELLOW},
  {&Crystal_24_Italic, nullptr,  "CRYSTAL_24", COLOR16M_BLACK, COLOR16M_YELLOW},
  {&Chancery_24_Italic, nullptr,  "Chancery_24_Italic", COLOR16M_GREEN, COLOR16M_GREEN},
  {&OpenSans24, nullptr,  "OpenSans 24", COLOR16M_RED, COLOR16M_YELLOW},
  {nullptr, &FreeMonoBoldOblique12pt7b,  "GFX FreeMonoBoldOblique12pt7b", COLOR16M_WHITE, COLOR16M_WHITE},
  {nullptr, &FreeMonoBoldOblique12pt7b,  "GFX FreeMonoBoldOblique12pt7b", COLOR16M_RED, COLOR16M_YELLOW},
  {nullptr, &FreeSerif12pt7b,  "GFX FreeSerif12pt7b", COLOR16M_WHITE, COLOR16M_WHITE},
  {nullptr, &FreeSerif12pt7b,  "GFX FreeSerif12pt7b", COLOR16M_RED, COLOR16M_YELLOW},
...
void setup() {
  ...
  tft.setTextColor(COLOR16M_WHITE);
  tft.setFont(Arial_14);
  displayStuff("Arial_14");

  tft.setTextColor(COLOR16M_YELLOW);
...
//  stepThrough(); // Is this intentional?
  ...
  tft.setTextColor(COLOR16M_BLACK, COLOR16M_YELLOW);
  ...
  tft.setTextColor(COLOR16M_RED, COLOR16M_YELLOW);
...
uint32_t displayStuff1()
{
  ...
  tft.drawRect(rect_x, rect_y, 100, 50, COLOR16M_WHITE);
  for (uint16_t y = rect_y + 5; y < rect_y + 50; y += 5)
    tft.drawFastHLine(rect_x + 1, y, 98, COLOR16M_PINK);
  for (uint16_t x = rect_x + 5; x < rect_x + 100; x += 5)
    tft.drawFastVLine(x, rect_y+1, 48, COLOR16M_PINK);
  tft.setCursor(width / 2, height - 50, true);
  tft.print("Center");

  // Lets try again with CENTER X keyword.
  rect_y -= 100;
  tft.drawRect(rect_x, rect_y, 100, 50, COLOR16M_PINK);
  for (uint16_t y = rect_y + 5; y < rect_y + 50; y += 5)
    tft.drawFastHLine(rect_x + 1, y, 98, COLOR16M_CYAN);
  for (uint16_t x = rect_x + 5; x < rect_x + 100; x += 5)
    tft.drawFastVLine(x, rect_y+1, 48, COLOR16M_CYAN);
  ...
  tft.drawRect(rect_x, rect_y, 100, 50, COLOR16M_CYAN);
  for (uint16_t y = rect_y + 5; y < rect_y + 50; y += 5)
    tft.drawFastHLine(rect_x + 1, y, 98, COLOR16M_PINK);
  for (uint16_t x = rect_x + 5; x < rect_x + 100; x += 5)
  ...
  tft.print(rectText);
  tft.drawRect(xT, yT, wT, hT, COLOR16M_CYAN);
  ...
  for (uint8_t i = 0; i < sizeof(alternating_text); i++) {
    if (i & 1) tft.setTextColor(COLOR16M_WHITE, COLOR16M_RED);
    else tft.setTextColor(COLOR16M_YELLOW, COLOR16M_BLUE);
